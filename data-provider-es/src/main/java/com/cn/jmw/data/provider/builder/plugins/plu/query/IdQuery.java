 ...
 * @author jmw
 * @Description TODO
 * @date 2022年11月22日 13:53
 * @Version 1.0
 */
public class IdQuery extends QueryPlugin {
    ...
    public IdQuery(ThreadLocalCache threadLocalCache){
    ...
    public void append(ThreadLocalCache threadLocalCache) {
        ...
        searchRequest.source(new SearchSourceBuilder().query(QueryBuilders.termQuery("_id", esRequestParam.getId())));
        try {
