 ...
 * @author jmw
 * @Description TODO
 * @date 2022年11月22日 14:06
 * @Version 1.0
 */
public class FuzzyQuery extends QueryPlugin {
    ...
    public FuzzyQuery(ThreadLocalCache threadLocalCache){
    ...
    public void append(ThreadLocalCache threadLocalCache) {
        ...
        searchRequest.source(new SearchSourceBuilder().query(QueryBuilders.fuzzyQuery(esRequestParam.getQuery(), esRequestParam.getValue()).fuzziness(Fuzziness.AUTO)));
        try {
